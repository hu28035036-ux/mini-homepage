...
function DraggableBlock({ block, editMode, cardStyle, selected, outOfBounds, effectiveOpacity, effectiveFontSize, textColor, cardBackgroundColor, onSelect, onChange, onExpand, onQuickAdd, onBringForward, onSendBackward, onDelete, onDraw, children }: DraggableBlockProps) {
